                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/1.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a1.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/2.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a2.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                ...
                                                <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/3.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a3.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                        </div>
                                                        <div class="product-detail detail-center detail-inverse">
                                                            <div class="detail-title">
                                                ...
                                                <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/4.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a4.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                ...
                                                <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/5.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a5.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                ...
                                                <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/6.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a5.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                ...
                                                <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/7.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a7.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                ...
                                                <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                    <div class="product-box">
                                                        <div class="product-imgbox">
                                                            <div class="product-front">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/8.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
                                                            <div class="product-back">
                                                                <a href="product-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-4/product/a8.jpg" class="img-fluid  " alt="product"> </a>
                                                            </div>
